...
<div id="Panel">
        ...
        <k  id="1" class="bot cambioColor" value=" 1 " onclick="seleccionado1(id)"> Diapositiva 1<k>

      </div>
      <div id="PanelO" >

        <input id="agregar" type="button" value="[+]" onclick="agregar1(); dianueva(); " class="bote" />


        <input id="quitar" type="button" value="[-]" onclick="eliminarbtn();" class="bote" />
